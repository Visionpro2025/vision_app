...
# -*- coding: utf-8 -*-
"""
VISION PREMIUM - Versión Simplificada
Sin optimizaciones para identificar problemas
"""
...
with st.sidebar:
    ...
    # Selector de tema
    theme_options = ["light", "dark", "premium", "professional"]
    theme_display_names = {
        "light": "🌞 Tema Claro",
        "dark": "🌙 Tema Oscuro", 
    ...
    if selected_theme != st.session_state.get("current_theme", "light"):
        st.session_state.current_theme = selected_theme
        st.rerun()
    
    # Mostrar información del tema actual
    st.info(f"Tema actual: {theme_display_names[current_theme]}")
...
st.warning("**Versión Simplificada** - Optimizaciones deshabilitadas temporalmente para diagnóstico")
